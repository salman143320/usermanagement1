    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(url('/userregister')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <a style="color: #fff;border: none;text-decoration: none;" href="<?php echo e(url('/userlogin')); ?>">Login</a>
                                </button>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\todo\resources\views/userregister.blade.php ENDPATH**/ ?>